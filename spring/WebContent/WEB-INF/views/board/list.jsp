...
<head>
<title>게시판</title>
<link href="/spring/resource/style/style_board.css" rel="stylesheet"
	type="text/css">
</head>
		...
		<table width="700">
			<tr>
				<td align="right" bgcolor="${value_c}"><a
					href="/spring/board/writeForm.do">글쓰기</a></td>
			</tr>
		</table>
				...
				<c:forEach var="article" items="${articleList}">
					<tr height="30">
						...
						<td width="250"><c:if test="${article.re_level > 0}">
								<img src="/spring/resource/etc/images/level.gif"
							...
							href="/srping/board/content.do?num=${article.num}&pageNum=${currentPage}">
								${article.subject}</a> <c:if test="${article.readcount >= 20}">
								<img src="/spring/resource/etc/images/hot.gif" border="0"
									height="16">
							</c:if></td>
