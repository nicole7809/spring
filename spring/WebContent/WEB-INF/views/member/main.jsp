		...
		<table width=500 cellpadding="0" cellspacing="0" align="center"
			...
			<tr>
				...
				<form name="inform" method="post"
					action="/spring/member/loginPro.do" onSubmit="return checkIt();">
			...
			<tr>
				<td colspan="3" bgcolor="${title_c}" align="center"><input
					...
					onclick="javascript:window.location='/spring/member/inputForm.do'"></td>
				</form>
			</tr>
		</table>
</c:if>
			...
			<td rowspan="3" bgcolor="${value_c}" align="center">
				...
				<form method="post" action="/spring/member/logout.do">
					<input type="submit" value="로그아웃"> <input type="button"
						value="회원정보변경"
						onclick="javascript:window.location='/spring/member/modify.do'">
				</form>
			</td>
		</tr>
		<tr>
