...
<head>
<title>로그인</title>
<link href="/spring/resource/style/style.css" rel="stylesheet"
	type="text/css">
...
<body bgcolor="${bodyback_c}">
	<form method="post" action="/spring/member/modifyPro.do"
		...
		<table width="600" border="1" cellspacing="0" cellpadding="3"
			...
			<tr>
				...
				<input type="password" name="passwd" size="10"
					maxlength="10" value="${c.passwd}"></td>
			<tr>
			<tr>
			...
			<tr>
				...
				<td width="400"><input type="text" name="name" size="15"
					maxlength="20" value="${c.name}"></td>
			</tr>
			<tr>
				<td width="200">주민등록번호</td>
				<td width="400">${c.jumin1}-${c.jumin2}</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<input type="button" value="취  소"
					onclick="javascript:window.location='/spring/member/main.do'">
				</td>
			</tr>
		</table>
	</form>
